...
export default function Nav() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-20 px-6 py-4 flex items-center justify-between bg-ravens-dark/85 backdrop-blur-md border-b border-ravens-border">
      {/* Logo */}
      ...
      {open && (
        <div className="absolute top-full left-0 right-0 bg-ravens-surface border-b border-ravens-border px-6 py-4 flex flex-col gap-4 md:hidden">
          ...
          <NavLink href="/kit" onClick={() => setOpen(false)}>Shop</NavLink>
